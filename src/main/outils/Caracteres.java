...
public class Caracteres {
    ...
    public static void chargerCaracteres() {
        ...
        Caracteres.enregistrerCaractere(Constantes.VALEUR_PIEGE, "O");
        ...
        Caracteres.enregistrerCaractere(Constantes.VALEUR_ARCHER, "A");
        //Caracteres.enregistrerCaractere(Constantes.VALEUR_TAUREAU, "\uD83D\uDC2E", true);
        Caracteres.enregistrerCaractere(Constantes.VALEUR_TAUREAU, "T");
